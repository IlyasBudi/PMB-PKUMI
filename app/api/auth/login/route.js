...
export async function POST(req) {
  ...
  // teruskan ke Laravel API
  const res = await fetch("https://doorprize-admin.my.id/api/registration/login", {
    method: "POST",
  ...
  return NextResponse.json({ status: "error", message: data.message }, { status: 401 })
}
