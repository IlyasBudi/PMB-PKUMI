      ...
      <div className="grid min-h-screen place-items-center backdrop-blur-2xl">
        <div className="my-10 flex flex-col items-center gap-7">
          <h1 className="text-3xl font-semibold text-gray-900">
            Register <span className="font-bold">PMB</span>
          </h1>
          <div className="flex max-w-[90vw] flex-col gap-4 rounded-lg border border-[#9ce8d8] bg-white p-6 shadow-xl shadow-[#1ABC9C]/10 md:max-w-[26rem] md:p-8">
            <h1 className="mx-auto -mb-3 text-2xl font-semibold text-gray-800">Buat Akun Baru</h1>
            <h3 className="mx-auto max-w-[80%] text-center font-light text-gray-600 md:text-sm">Lengkapi data untuk melanjutkan pendaftaran</h3>
            <FormRegister />
            <small>
              sudah memiliki akun?
              <Link href={constants.CLIENT_PATH.LOGIN} className="ml-1 text-blue-500 hover:underline">
                Masuk
              </Link>
            </small>
